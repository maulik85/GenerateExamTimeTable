...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Program">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'faculty.code', name: 'faculty.code' },
{ data: 'college', name: 'colleges.name' },
{ data: 'level_name', name: 'level.name' },
{ data: 'level.code', name: 'level.code' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Program').DataTable(dtOverrideGlobals);
