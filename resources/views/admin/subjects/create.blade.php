    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.subjects.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('classroom_hours') ? 'is-invalid' : '' }}" type="text" name="classroom_hours" id="classroom_hours" value="{{ old('classroom_hours', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tutorial_hours') ? 'is-invalid' : '' }}" type="text" name="tutorial_hours" id="tutorial_hours" value="{{ old('tutorial_hours', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lab_hours') ? 'is-invalid' : '' }}" type="text" name="lab_hours" id="lab_hours" value="{{ old('lab_hours', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('theory_exam_hours') ? 'is-invalid' : '' }}" type="text" name="theory_exam_hours" id="theory_exam_hours" value="{{ old('theory_exam_hours', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('practical_exam_hours') ? 'is-invalid' : '' }}" type="text" name="practical_exam_hours" id="practical_exam_hours" value="{{ old('practical_exam_hours', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('theory_intl_marks') ? 'is-invalid' : '' }}" type="number" name="theory_intl_marks" id="theory_intl_marks" value="{{ old('theory_intl_marks', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('theory_intl_passing_marks') ? 'is-invalid' : '' }}" type="number" name="theory_intl_passing_marks" id="theory_intl_passing_marks" value="{{ old('theory_intl_passing_marks', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('theory_ext_marks') ? 'is-invalid' : '' }}" type="number" name="theory_ext_marks" id="theory_ext_marks" value="{{ old('theory_ext_marks', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('theory_ext_passing_marks') ? 'is-invalid' : '' }}" type="number" name="theory_ext_passing_marks" id="theory_ext_passing_marks" value="{{ old('theory_ext_passing_marks', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('practical_intl_marks') ? 'is-invalid' : '' }}" type="number" name="practical_intl_marks" id="practical_intl_marks" value="{{ old('practical_intl_marks', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('practical_intl_passing_marks') ? 'is-invalid' : '' }}" type="number" name="practical_intl_passing_marks" id="practical_intl_passing_marks" value="{{ old('practical_intl_passing_marks', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('practical_ext_marks') ? 'is-invalid' : '' }}" type="number" name="practical_ext_marks" id="practical_ext_marks" value="{{ old('practical_ext_marks', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('practical_ext_passing_marks') ? 'is-invalid' : '' }}" type="number" name="practical_ext_passing_marks" id="practical_ext_passing_marks" value="{{ old('practical_ext_passing_marks', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_marks') ? 'is-invalid' : '' }}" type="number" name="total_marks" id="total_marks" value="{{ old('total_marks', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_passing_marks') ? 'is-invalid' : '' }}" type="number" name="total_passing_marks" id="total_passing_marks" value="{{ old('total_passing_marks', '') }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('elective') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="elective" id="elective" value="1" {{ old('elective', 0) == 1 ? 'checked' : '' }}>
