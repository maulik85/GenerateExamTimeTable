...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-TimeTable">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.time-tables.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'name', name: 'name' },
{ data: 'program_title', name: 'program.title' },
{ data: 'program.code', name: 'program.code' },
{ data: 'program.category', name: 'program.category' },
{ data: 'semester', name: 'semester' },
{ data: 'year', name: 'year' },
{ data: 'exam_available_days_name', name: 'exam_available_days.name' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-TimeTable').DataTable(dtOverrideGlobals);
