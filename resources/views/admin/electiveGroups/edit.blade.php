...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.elective-groups.update", [$electiveGroup->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $electiveGroup->name) }}" required>
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('offered_subjects_in_group') ? 'is-invalid' : '' }}" type="number" name="offered_subjects_in_group" id="offered_subjects_in_group" value="{{ old('offered_subjects_in_group', $electiveGroup->offered_subjects_in_group) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_subjects_allowed') ? 'is-invalid' : '' }}" type="number" name="max_subjects_allowed" id="max_subjects_allowed" value="{{ old('max_subjects_allowed', $electiveGroup->max_subjects_allowed) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_subjects_required') ? 'is-invalid' : '' }}" type="number" name="min_subjects_required" id="min_subjects_required" value="{{ old('min_subjects_required', $electiveGroup->min_subjects_required) }}" step="1">
