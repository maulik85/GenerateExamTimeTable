...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ElectiveGroup">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.elective-groups.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'programs', name: 'programs.title' },
{ data: 'name', name: 'name' },
{ data: 'offered_subjects_in_group', name: 'offered_subjects_in_group' },
{ data: 'max_subjects_allowed', name: 'max_subjects_allowed' },
{ data: 'min_subjects_required', name: 'min_subjects_required' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-ElectiveGroup').DataTable(dtOverrideGlobals);
