...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.exam-available-days.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('exam_start_date') ? 'is-invalid' : '' }}" type="text" name="exam_start_date" id="exam_start_date" value="{{ old('exam_start_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_1') ? 'is-invalid' : '' }}" type="text" name="day_1" id="day_1" value="{{ old('day_1') }}">
                @if($errors->has('day_1'))
                    <div class="invalid-feedback">
                        {{ $errors->first('day_1') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_2') ? 'is-invalid' : '' }}" type="text" name="day_2" id="day_2" value="{{ old('day_2') }}">
                @if($errors->has('day_2'))
                    <div class="invalid-feedback">
                        {{ $errors->first('day_2') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_3') ? 'is-invalid' : '' }}" type="text" name="day_3" id="day_3" value="{{ old('day_3') }}">
                @if($errors->has('day_3'))
                    <div class="invalid-feedback">
                        {{ $errors->first('day_3') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_4') ? 'is-invalid' : '' }}" type="text" name="day_4" id="day_4" value="{{ old('day_4') }}">
                @if($errors->has('day_4'))
                    <div class="invalid-feedback">
                        {{ $errors->first('day_4') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_5') ? 'is-invalid' : '' }}" type="text" name="day_5" id="day_5" value="{{ old('day_5') }}">
                @if($errors->has('day_5'))
                    <div class="invalid-feedback">
                        {{ $errors->first('day_5') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_6') ? 'is-invalid' : '' }}" type="text" name="day_6" id="day_6" value="{{ old('day_6') }}">
                @if($errors->has('day_6'))
                    <div class="invalid-feedback">
                        {{ $errors->first('day_6') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_7') ? 'is-invalid' : '' }}" type="text" name="day_7" id="day_7" value="{{ old('day_7') }}">
                @if($errors->has('day_7'))
                    <div class="invalid-feedback">
                        {{ $errors->first('day_7') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_8') ? 'is-invalid' : '' }}" type="text" name="day_8" id="day_8" value="{{ old('day_8') }}">
                @if($errors->has('day_8'))
                    <div class="invalid-feedback">
                        {{ $errors->first('day_8') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_9') ? 'is-invalid' : '' }}" type="text" name="day_9" id="day_9" value="{{ old('day_9') }}">
                @if($errors->has('day_9'))
                    <div class="invalid-feedback">
                        {{ $errors->first('day_9') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_10') ? 'is-invalid' : '' }}" type="text" name="day_10" id="day_10" value="{{ old('day_10') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_11') ? 'is-invalid' : '' }}" type="text" name="day_11" id="day_11" value="{{ old('day_11') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_12') ? 'is-invalid' : '' }}" type="text" name="day_12" id="day_12" value="{{ old('day_12') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_13') ? 'is-invalid' : '' }}" type="text" name="day_13" id="day_13" value="{{ old('day_13') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_14') ? 'is-invalid' : '' }}" type="text" name="day_14" id="day_14" value="{{ old('day_14') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_15') ? 'is-invalid' : '' }}" type="text" name="day_15" id="day_15" value="{{ old('day_15') }}">
