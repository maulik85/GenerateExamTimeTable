                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.subjects.update", [$subject->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="semester" id="semester" value="{{ old('semester', $subject->semester) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="year" id="year" value="{{ old('year', $subject->year) }}" step="1">
                            @if($errors->has('year'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('year') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="category" id="category" value="{{ old('category', $subject->category) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="code" id="code" value="{{ old('code', $subject->code) }}" required>
                            @if($errors->has('code'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('code') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $subject->title) }}" required>
                            @if($errors->has('title'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('title') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="credits" id="credits" value="{{ old('credits', $subject->credits) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="classroom_hours" id="classroom_hours" value="{{ old('classroom_hours', $subject->classroom_hours) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tutorial_hours" id="tutorial_hours" value="{{ old('tutorial_hours', $subject->tutorial_hours) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lab_hours" id="lab_hours" value="{{ old('lab_hours', $subject->lab_hours) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="theory_exam_hours" id="theory_exam_hours" value="{{ old('theory_exam_hours', $subject->theory_exam_hours) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="practical_exam_hours" id="practical_exam_hours" value="{{ old('practical_exam_hours', $subject->practical_exam_hours) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="theory_intl_marks" id="theory_intl_marks" value="{{ old('theory_intl_marks', $subject->theory_intl_marks) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="theory_intl_passing_marks" id="theory_intl_passing_marks" value="{{ old('theory_intl_passing_marks', $subject->theory_intl_passing_marks) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="theory_ext_marks" id="theory_ext_marks" value="{{ old('theory_ext_marks', $subject->theory_ext_marks) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="theory_ext_passing_marks" id="theory_ext_passing_marks" value="{{ old('theory_ext_passing_marks', $subject->theory_ext_passing_marks) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="practical_intl_marks" id="practical_intl_marks" value="{{ old('practical_intl_marks', $subject->practical_intl_marks) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="practical_intl_passing_marks" id="practical_intl_passing_marks" value="{{ old('practical_intl_passing_marks', $subject->practical_intl_passing_marks) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="practical_ext_marks" id="practical_ext_marks" value="{{ old('practical_ext_marks', $subject->practical_ext_marks) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="practical_ext_passing_marks" id="practical_ext_passing_marks" value="{{ old('practical_ext_passing_marks', $subject->practical_ext_passing_marks) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_marks" id="total_marks" value="{{ old('total_marks', $subject->total_marks) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_passing_marks" id="total_passing_marks" value="{{ old('total_passing_marks', $subject->total_passing_marks) }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="elective" id="elective" value="1" {{ $subject->elective || old('elective', 0) === 1 ? 'checked' : '' }}>
