                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.time-tables.update", [$timeTable->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $timeTable->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="semester" id="semester" value="{{ old('semester', $timeTable->semester) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="year" id="year" value="{{ old('year', $timeTable->year) }}">
                            @if($errors->has('year'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('year') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="exam_available_days_id" id="exam_available_days_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="start_time" id="start_time" value="{{ old('start_time', $timeTable->start_time) }}">
