    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.exam-available-days.update", [$examAvailableDay->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.examAvailableDay.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $examAvailableDay->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="exam_start_date" id="exam_start_date" value="{{ old('exam_start_date', $examAvailableDay->exam_start_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_1" id="day_1" value="{{ old('day_1', $examAvailableDay->day_1) }}">
                            @if($errors->has('day_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('day_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_2" id="day_2" value="{{ old('day_2', $examAvailableDay->day_2) }}">
                            @if($errors->has('day_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('day_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_3" id="day_3" value="{{ old('day_3', $examAvailableDay->day_3) }}">
                            @if($errors->has('day_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('day_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_4" id="day_4" value="{{ old('day_4', $examAvailableDay->day_4) }}">
                            @if($errors->has('day_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('day_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_5" id="day_5" value="{{ old('day_5', $examAvailableDay->day_5) }}">
                            @if($errors->has('day_5'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('day_5') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_6" id="day_6" value="{{ old('day_6', $examAvailableDay->day_6) }}">
                            @if($errors->has('day_6'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('day_6') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_7" id="day_7" value="{{ old('day_7', $examAvailableDay->day_7) }}">
                            @if($errors->has('day_7'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('day_7') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_8" id="day_8" value="{{ old('day_8', $examAvailableDay->day_8) }}">
                            @if($errors->has('day_8'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('day_8') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_9" id="day_9" value="{{ old('day_9', $examAvailableDay->day_9) }}">
                            @if($errors->has('day_9'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('day_9') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_10" id="day_10" value="{{ old('day_10', $examAvailableDay->day_10) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_11" id="day_11" value="{{ old('day_11', $examAvailableDay->day_11) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_12" id="day_12" value="{{ old('day_12', $examAvailableDay->day_12) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_13" id="day_13" value="{{ old('day_13', $examAvailableDay->day_13) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_14" id="day_14" value="{{ old('day_14', $examAvailableDay->day_14) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="day_15" id="day_15" value="{{ old('day_15', $examAvailableDay->day_15) }}">
