    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.elective-groups.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="offered_subjects_in_group" id="offered_subjects_in_group" value="{{ old('offered_subjects_in_group', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="max_subjects_allowed" id="max_subjects_allowed" value="{{ old('max_subjects_allowed', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="min_subjects_required" id="min_subjects_required" value="{{ old('min_subjects_required', '') }}" step="1">
