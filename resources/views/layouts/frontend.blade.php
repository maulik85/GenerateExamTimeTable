                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('college_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.colleges.index') }}">
                                    ...
                                    @endcan
                                    @can('program_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.programs.index') }}">
                                            {{ trans('cruds.program.title') }}
                                        </a>
                                    @endcan
                                    @can('elective_group_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.elective-groups.index') }}">
                                    ...
                                    @can('exam_available_day_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.exam-available-days.index') }}">
                                    ...
                                    @can('time_table_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.time-tables.index') }}">
